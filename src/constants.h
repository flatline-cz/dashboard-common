 ...
 */
#ifndef DASHBOARD_COMMON_CONSTANTS_H
#define DASHBOARD_COMMON_CONSTANTS_H

#define CMD_LENGTH        1024
#define BUFFER_COUNT        64

#define UDS_MAX_RECORD_LENGTH       256

#define SELECT_TIMEOUT       1UL

#endif //DASHBOARD_COMMON_CONSTANTS_H
